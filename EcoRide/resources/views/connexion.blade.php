...
@section('content')
    <div class="w-full h-full mt-75 mb-10 xl:mt-5 xl:mb-0">
        <div class="flex flex-col justify-center h-181 mb-50 ml-20 mr-20 2xl:ml-150 2xl:mr-150 2xl:mb-5">
            <form method="POST" id="formConnexion" action="{{ route('utilisateur.connexion') }}">
                @csrf
                ...
                <div class="flex flex-col border-2 border-green1 rounded-b-3xl p-20 pt-10 pb-10">
                    <div class="flex flex-col items-center justify-center gap-4">
                        <button type="submit" class="border-2 border-black text-4xl font-second bg-green1 rounded-3xl w-2xs h-18 xl:w-3xs xl:h-12">
                            CONNEXION
                        </button>
