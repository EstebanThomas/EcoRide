<header>
    ...
    <div class="relative hidden xl:block">
        ...
        <nav class="absolute flex justify-evenly items-center w-[800px] h-[65] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-[20px]"> <!-- xs:top-[45px] left-1/2 and top-1/2 = put corner high right center and -translate-x-1/2 -translate-y-1/2 = recenter -->
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col hover:text-green1" href="/"><img src="{{ asset('images/Accueil.svg') }}" alt="Logo Accueil">ACCUEIL</a>
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col hover:text-green1" href="/covoiturages"><img src="{{ asset('images/Covoiturages.svg') }}" alt="Logo Covoiturages">COVOITURAGES</a>
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col hover:text-green1" href="/connexion"><img src="{{ asset('images/Connexion.svg') }}" alt="Logo Connexion">CONNEXION</a>
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col hover:text-green1" href="/contact"><img src="{{ asset('images/Contact.svg') }}" alt="Logo Contact">CONTACT</a>
        </nav>
    ...
    <div class="relative block xl:hidden">
        ...
        <nav class="absolute flex justify-evenly items-center h-[100px] w-[calc(100%-4rem)] top-[230px] left-1/2 -translate-x-1/2 bg-green4 rounded-3xl border border-green1"> <!-- left-1/2 and top-1/2 = put corner high right center and -translate-x-1/2 -translate-y-1/2 = recenter -->
            <a class="font-second text-4xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col" href="/"><img src="{{ asset('images/Accueil.svg') }}" alt="Logo Accueil" class="w-15 h-15">ACCUEIL</a>
            <a class="font-second text-4xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col" href="/covoiturages"><img src="{{ asset('images/Covoiturages.svg') }}" alt="Logo Covoiturages" class="w-15 h-15">COVOITURAGES</a>
