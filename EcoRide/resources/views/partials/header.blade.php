<header>
    ...
    <div class="relative hidden xl:block">
        ...
        <nav class="absolute flex justify-evenly items-center w-[800px] h-[65] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-[20px]"> <!-- xs:top-[45px] left-1/2 and top-1/2 = put corner high right center and -translate-x-1/2 -translate-y-1/2 = recenter -->
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col" href="/"><img src="{{ asset('images/Accueil.svg') }}" alt="Logo Accueil">ACCUEIL</a>
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col" href="/covoiturages"><img src="{{ asset('images/Covoiturages.svg') }}" alt="Logo Covoiturages">COVOITURAGES</a>
            <a class="font-second text-2xl tracking-wide flex w-[200px] h-[55px] items-center justify-center flex-col" href="/connexion"><img src="{{ asset('images/Connexion.svg') }}" alt="Logo Connexion">CONNEXION</a>
