        ...
        <div class="flex flex-col justify-center h-200 mb-50 ml-20 mr-20 2xl:ml-100 2xl:mr-100 2xl:mb-5">
            <form method="POST" action="{{ route('utilisateur.creation') }}">
                ...
                <div class="flex flex-col border-2 border-t-2 border-b-0 border-green1 p-20 pt-10 pb-10 xl:pt-5 xl:pb-5">
                    ...
                    <div>
                        <p class="flex justify-center font-second text-3xl uppercase mt-2">
                            Le mote de passe doit contenir :
                        </p>
                        <div class="flex flex-row justify-center gap-10">
                            <div class="flex flex-col justify-center items-center">
                                <p id="lengthError" class="font-second text-2xl uppercase text-center">
                                    Au moins 12 caractères
                                </p>
                                <p id="lowercaseError" class="font-second text-2xl uppercase mb-2 text-center">
                                    Au moins une minuscule
                                </p>
                            </div>
                            <div class="flex flex-col justify-center items-center">
                                <p id="uppercaseError" class="font-second text-2xl uppercase text-center">
                                    Au moins une majuscule
                                </p>
                                <p id="numberError" class="font-second text-2xl uppercase mb-2 text-center">
                                    Au moins un chiffre
                                </p>
                            </div>
                        </div>
                ...
                <div class="flex flex-col justify-center items-center border-2 border-green1 rounded-b-3xl p-20 pt-10 pb-10 xl:pt-5 xl:pb-5 mb-20">
                        <button type="submit" class="border-2 border-black text-5xl xl:text-4xl font-second bg-green1 hover:bg-green2 active:bg-green1 rounded-3xl w-2xs h-18 xl:w-3xs xl:h-12">
                            INSCRIPTION
                        </button>
                </div>
