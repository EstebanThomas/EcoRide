...
@section('content')
    <div class="w-full h-full mt-105 mb-10 xl:mt-5 xl:mb-0">
        <div class="flex flex-col justify-center h-200 mb-50 ml-20 mr-20 2xl:ml-100 2xl:mr-100 2xl:mb-5">
            <form method="POST" action="{{ route('utilisateur.creation') }}">

                @csrf

                <div class="flex flex-col border-2 border-green1 rounded-t-3xl p-20 pt-10 pb-10 xl:pt-5 xl:pb-5 mt-25">
                ...
                <div class="flex flex-col border-2 border-t-2 border-b-0 border-green1 p-20 pt-10 pb-10 xl:pt-5 xl:pb-5">
                    ...
                    <div>
                        <p class="flex justify-center font-second text-3xl xl:text-xl uppercase mt-2">
                            Le mote de passe doit contenir :
                        </p>
                        <div class="flex flex-row justify-center gap-10">
                            <div class="flex flex-col justify-center items-center">
                                <p id="lengthError" class="font-second text-2xl xl:text-xl uppercase text-center">
                                    Au moins 12 caractères
                                </p>
                                <p id="lowercaseError" class="font-second text-2xl xl:text-xl uppercase mb-2 text-center">
                                    Au moins une minuscule
                                </p>
                            </div>
                            <div class="flex flex-col justify-center items-center">
                                <p id="uppercaseError" class="font-second text-2xl xl:text-xl uppercase text-center">
                                    Au moins une majuscule
                                </p>
                                <p id="numberError" class="font-second text-2xl xl:text-xl uppercase mb-2 text-center">
                                    Au moins un chiffre
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                    <label for="password_confirmation" class="font-second text-4xl xl:text-2xl">CONFIRMATION DU MOT DE PASSE</label>
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Entrez le mot de passe" required
                        class="bg-green4 w-full h-18 xl:h-10 focus:border-2 focus:border-green1 focus:outline focus:outline-green1 font-second text-4xl xl:text-2xl placeholder-black p-2"/>
                    </div>
                </div>

                <div class="flex flex-col justify-center items-center border-2 border-green1 rounded-b-3xl p-20 pt-10 pb-10 xl:pt-5 xl:pb-5 mb-20">
                        <button type="submit" class="border-2 border-black text-5xl xl:text-2xl font-second bg-green1 hover:bg-green2 active:bg-green1 rounded-3xl w-2xs h-18 xl:w-3xs xl:h-12">
                            INSCRIPTION
                        </button>
                </div>
