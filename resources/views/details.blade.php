    ...
    <div class="w-full h-full mt-75 xl:mt-5 flex justify-center items-center flex-col">
        <div class="flex flex-col xl:flex-row ml-2 mr-2 justify-center items-center gap-5 xl:gap-2">
            <div class="flex flex-row justify-center items-center gap-10 xl:gap-5 w-full xl:w-2/3 border-4 border-green1 rounded-3xl p-5 xl:p-2">
                ...
                <div class="flex flex-col justify-center items-center gap-10">
                    <p class="text-4xl xl:text-3xl font-second text-black">{{ $covoiturage->utilisateur->pseudo }}</p>
                    <p class="text-4xl xl:text-3xl font-second text-black flex flex-row items-center justify-center gap-2">
                ...
                <div class="flex flex-col justify-center items-center gap-2 border border-green1 rounded-3xl bg-green4 p-5 mr-5">
                    <p class="text-4xl xl:text-3xl font-second text-black uppercase text-center">{{ $covoiturage->voiture->marque->libelle }}</p>
                    <p class="text-4xl xl:text-3xl font-second text-black uppercase text-center">{{ $covoiturage->voiture->modele }}</p>
                    @if($covoiturage->voiture->energie === 'Oui')
                        <p class="text-4xl xl:text-3xl font-second text-black uppercase">électrique</p>
                    @endif
                </div>
            </div>
        ...
        <div class="flex flex-col justify-center items-center border-4 border-green1 p-5 rounded-3xl mt-5 w-4/6">
            ...
            <div class="flex flex-row justify-center items-center gap-20">
                <div class="flex flex-row justify-center items-center gap-5 bg-green4 border-2 border-green1 rounded-3xl p-2 mt-5">
                    ...
                    @if($covoiturage->utilisateur->preferences->fumeur === 'Oui')
                ...
                <div class="flex flex-row justify-center items-center gap-5 bg-green4 border-2 border-green1 rounded-3xl p-2 mt-5">
                    ...
                    @if($covoiturage->utilisateur->preferences->animaux === 'Oui')
            ...
            @if(!empty($covoiturage->utilisateur->preferences->propres_preferences))
                <div class="border-2 border-green1 rounded-3xl bg-green4 p-2 mt-5">
                    <p class="font-second text-black text-4xl xl:text-3xl">{{$covoiturage->utilisateur->preferences->propres_preferences}}<p>
                </div>
            @endif
        </div>
        ...
        <div class="bg-white border-4 border-green1 rounded-3xl w-4/6 h-full flex flex-col mt-5 gap-5">
            <div class="border-b-4 border-green1 w-full h-1/2 flex flex-row gap-3 p-5 justify-center items-center">
                <div class="flex flex-row items-center justify-center w-full h-full gap-2 font-second text-5xl xl:text-4xl text-black">
            ...
            <div class="w-full h-1/2 flex flex-col justify-center items-center gap-10 p-5">
                <div class="w-full flex flex-row justify-center items-center gap-5">
                    ...
                    <p class="font-second text-5xl xl:text-4xl text-black">
        ...
        <div class="mt-5 w-5/6 flex flex-col justify-center items-center mb-5">
            <h1 class="text-6xl xl:text-4xl font-second text-black uppercase m-2">
                AVIS
            </h1>
            <div class="border-4 rounded-3xl w-5/6 border-green1 p-2 overflow-y-auto h-200 flex flex-col items-center gap-4">
                @forelse($avis as $a)
                    <div class="border-3 border-green2 rounded-3xl p-4 my-2 w-full xl:w-200 text-5xl xl:text-3xl font-second">
                ...
                @empty
                    <p class="text-4xl xl:text-3xl font-second text-gray-600">Aucun avis n’a encore été publié sur ce conducteur.</p>
                @endforelse
            </div>
